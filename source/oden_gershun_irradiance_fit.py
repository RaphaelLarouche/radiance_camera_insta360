...
if __name__ == "__main__":
    # Simulation
    wavelength = 600
    a_ice_red, a_ice_green, a_ice_blue = 0.15, 0.081, 0.08,
    ...
    oden_simulation = SeaIceSimulation(root_name=root_name, run_title=root_name, mode="Oden", wavelength_list=[wavelength])
