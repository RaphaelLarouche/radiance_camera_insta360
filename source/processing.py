...
class ProcessImage:
    ...
    #     """
    #     Polynomial fit with even coefficient (degree 2 to 6) for roll-off fitting. Degree 0 is set to 1.
    #     :param x:
    #     :param a1:
    #     :param a2:
    #     :param a3:
    ...
    #
    # def rolloff_curvefit_matlab(self, angles, data):
    #     """
    #
    #     :param angles: in degrees
    #     :param data: roll-off data (normalization of the curves by their maximum)
    #     :return:
    #     """
    #
    #     popt, pcov = curve_fit(self.rolloff_matlab, angles, data)
    #     rsquared, perr = self.rsquare(self.rolloff_matlab, popt, pcov, angles, data)
    #
    #     return popt, pcov, rsquared, perr
    #
