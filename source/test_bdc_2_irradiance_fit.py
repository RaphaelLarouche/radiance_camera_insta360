...
if __name__ == "__main__":
    # Simulation
    wavelength = 540
    a_sw_red, a_sw_green, a_sw_blue = 0.40, 0.05, 0.40
    root_name = "bdc_2_fit"
    ...
    oden_simulation = SeaIceSimulation(root_name=root_name, run_title=root_name, mode="BaieDesChaleurs", wavelength_list=[wavelength], IrradDataFile="HE60BDC_irrad_cops_station_2")
    ...
    comparison = Comparator(RadClass=RadClass(data_path="baiedeschaleurs-03232022.h5", station="station_2", freeboard=18),
