...
if __name__ == "__main__":
    ...
    oden_simulation = SeaIceSimulation(root_name=root_name, run_title=root_name, mode="BaieDesChaleurs", wavelength_list=[wavelength], IrradDataFile="HE60BDC_irrad_cops_station_3")
    ...
    comparison = Comparator(RadClass=RadClass(data_path="baiedeschaleurs-03232022.h5", station="station_3", freeboard=15),
