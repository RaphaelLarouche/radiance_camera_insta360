...
if __name__ == "__main__":
    ...
    root_name = "fit_secret_iops_error01"
    ...
    # comp = HHComparator(SimulationDataviewer=DataViewer(root_name=root_name),
    #                        FieldDataViewer=DataViewer(root_name='secret_iops_error01'))
    # axes = comp.compare_irradiances(wavelengths=[600])
